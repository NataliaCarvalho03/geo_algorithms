...
# ------------------ Making the inverse transform (from milimetric coordinate system to digital)-----------------------------------

d_imgx = pixel_size_x * columms
d_imgy = pixel_size_y * rows


C = int((1/pixel_size_x) * ((d_imgx/2) + x))
L = int((1/pixel_size_y) * ((d_imgy/2) - y)) -1 #why????

print('The inverse transformation: ')
print(C, L)